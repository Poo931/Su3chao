<?php
namespace Mageplaza\SocialLogin\Model\ResourceModel\Social\Collection;

/**
 * Interceptor class for @see \Mageplaza\SocialLogin\Model\ResourceModel\Social\Collection
 */
class Interceptor extends \Mageplaza\SocialLogin\Model\ResourceModel\Social\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterOrder');
        return $pluginInfo ? $this->___callPlugins('filterOrder', func_get_args(), $pluginInfo) : parent::filterOrder($type);
    }
