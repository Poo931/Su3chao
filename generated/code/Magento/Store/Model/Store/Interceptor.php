...
class Interceptor extends \Magento\Store\Model\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'cleanUrlQueryString');
        return $pluginInfo ? $this->___callPlugins('cleanUrlQueryString', func_get_args(), $pluginInfo) : parent::cleanUrlQueryString($url);
    }
